...
class Contact extends Component {
    ...
    validate(firstname, lastname, telnum, email) {
        ...
        if (this.state.touched.telnum && !reg.test(telnum))
            errors.telnum = 'Tel. Number should contain only numbers of 10 digits';

        const reg1=/^(.+)@(.+)$/;
        if(this.state.touched.email && !reg1.test(email))
        errors.email = 'Email should be in form abc@abc.abc';
                ...
                <div className="col-12 col-md-9">
                    <Form onSubmit={this.handleSubmit}>
                        ...
                        <FormGroup row>
                            ...
                            <Col md={10}>
                                <Input type="textarea" id="message" rows="12" name="message"
